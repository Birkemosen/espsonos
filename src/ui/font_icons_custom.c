 ...
 * Size: 32 px
 * Bpp: 4
 * Opts: --bpp 4 --size 32 --no-compress --stride 1 --align 1 --font FontAwesome5-Solid+Brands+Regular.woff --range 61442,61830 --format lvgl -o font_icons_custom.c
 ******************************************************************************/
...
#ifndef FONT_ICONS_CUSTOM
#define FONT_ICONS_CUSTOM 1
#endif

#if FONT_ICONS_CUSTOM
...
static LV_ATTRIBUTE_LARGE_CONST const uint8_t glyph_bitmap[] = {
    ...
    0xff, 0xff, 0xfb, 0x62, 0x0, 0x0, 0x10, 0x0,
    ...
    0xde, 0xff, 0xdb, 0x84, 0x0, 0x0, 0x0, 0x0
};
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 512, .adv_w = 512, .box_w = 30, .box_h = 32, .ofs_x = 1, .ofs_y = -4}
};
...
{
    {
        .range_start = 61442, .range_length = 389, .glyph_id_start = 1,
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t font_icons_custom = {
#else
lv_font_t font_icons_custom = {
#endif
